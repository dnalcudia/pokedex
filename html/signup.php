            ...
            <div class="col-6">
              ...
              <span class="display-3 Home__title font-weight-bold">Up</span>
                 ...
                 <form action="signup.php" method="post" id="signup-form">
                    ...
                    <div class="form-group">
                      <label class="font-weight-light" for="inputCreditCard">Credit Card</label>
                      <input onkeyup="replaceLetters()" maxlength="18" type="text" name="creditCard" class="form-control" id="inputCreditCard" aria-describedby="creditCardDescription" placeholder="Enter your credit card number">
                      <small id="pwdDescription" class="font-weight-bold">Exactly 18 digits.</small>
                    </div>
                    <div class="form-group">
                      <label class="font-weight-light" for="inputCreditCard">Secret Number</label>
                      <input onkeyup="replaceLetters()" maxlength="3" type="password" name="secretNumber" class="form-control" id="inputSecretNumber" aria-describedby="secretNumberDescription" placeholder="Enter your secret number">
                      <small id="secretNumberescription" class="font-weight-bold">Three digit number that comes on the back of the credit card.</small>
                    </div>
                  </form>
