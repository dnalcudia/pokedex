...
WHERE u.correo = '$email'";
    ...
    //ya que tenemos el id del pokedek,y id_pokemon eliminaremos
    //el pokemon seleccionado dentro de dicho pokedek
    $sql = "DELETE FROM Pokedek_pokemon WHERE id_pokedek = '$id_pokedek' AND id_pokemon = '$id_pokemon'";
    if(mysqli_query($link, $sql)){
    	$sql = "DELETE FROM Pokemon WHERE id = '$id_pokemon'";
    	if(mysqli_query($link, $sql)){
